...
- `/delivery [status|stream|append|off|draft]` controls Telegram text preview behavior for the current chat (default `status`: milestones + final summary). It is not cron delivery.
