...
metadata:
  fft_nano: '{"emoji":"📋","requires":{"bins":["jq"],"env":["TRELLO_API_KEY","TRELLO_TOKEN"]}}'
  legacy_homepage: https://developer.atlassian.com/cloud/trello/rest/
---
...
Manage Trello boards, lists, and cards directly from fft_nano.
