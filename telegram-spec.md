...
| W3 think filtering | `src/pi-json-parser.ts` strips reasoning tags and holds trailing partial tag prefixes before `src/pi-runner.ts` publishes stream deltas.                                                                 | `tests/pi-json-parser.test.ts`                                                               |
...
| Think filtering                                       | `src/pi-json-parser.ts`, `src/pi-runner.ts`                        | `tests/pi-json-parser.test.ts`                                                      |
| Silence filtering                                     | `src/streaming/stream-filter.ts`                                   | `tests/stream-filter.test.ts`                                                       |
