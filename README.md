...
- Heartbeat loop is disabled by default. Set `FFT_NANO_HEARTBEAT_ENABLED=1` to run main-session checks using `HEARTBEAT.md`.
- Set cadence with `FFT_NANO_HEARTBEAT_EVERY` (e.g. `1h`, `4h`).
