...
- `./scripts/onboard-all.sh [--workspace /abs/path --env-path /abs/path/.env --runtime docker|host|auto --non-interactive --accept-risk --operator "Name" --assistant-name fft_nano --skip-setup --skip-restart --skip-doctor --no-backup --skip-channels --skip-skills --skip-health --skip-ui --install-daemon|--no-install-daemon]`
...
- `fft onboard --workspace /abs/path --env-path /abs/path/.env --operator "Name" --assistant-name fft_nano --non-interactive --accept-risk --auth-choice skip`
- `./scripts/onboard-all.sh --workspace /abs/path --env-path /abs/path/.env --operator "Name" --assistant-name fft_nano --non-interactive --accept-risk --auth-choice skip`
- `npm run onboard -- --workspace /abs/path --env-path /abs/path/.env --operator "Name" --assistant-name fft_nano --non-interactive --accept-risk --auth-choice skip`
- `./scripts/onboard.sh --workspace /abs/path --env-path /abs/path/.env --operator "Name" --assistant-name fft_nano --non-interactive --accept-risk --auth-choice skip`
